          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                required
                :type="user.showPassword.value ? 'text' : 'password'"
                v-model="user.password.value"
              />

              <button
                type="button"
                @click="user.showPassword.value = !user.showPassword.value"
                class="absolute inset-y-0 right-3 flex items-center text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
              >
                <!-- Eye (hidden) -->
                <svg
                  v-if="!user.showPassword.value"
          ...
          <div v-if="!isUpdate || isPasswordReset">
            ...
            <div class="relative">
              <input
                ...
                placeholder="Adja meg jelszavát"
                required
                :type="user.showConfirmPassword.value ? 'text' : 'password'"
              ...
              >
                <!-- Eye (hidden) -->
                <svg
                  v-if="!user.showConfirmPassword.value"
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
